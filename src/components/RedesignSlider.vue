<template>
  <div ref="customCursor" class="fancy montserrat container sm:w-lg w-full">
          ...
          >
            <router-link :to="image.link" class="w-full" @click="handleClick">
              ...
              <img
                ...
                :src="image.src"
                :alt="image.alt"
                class="w-full cursor-fancy h-auto sm:max-w-lg md:max-w-6xl object-cover group-hover:opacity-0 transition-opacity duration-500"
              />
              ...
              <img
                ...
                :src="image.hoverSrc"
                :alt="`${image.alt} hover`"
                class="w-full cursor-fancy  h-auto fancy sm:max-w-lg  md:max-w-5xl object-cover absolute top-0 left-20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              />
              <!-- Text directly on the image -->
              <div class="absolute cursor-fancy left-52 mt-44 inset-0 flex flex-col justify-center items-start p-8 group-hover:opacity-0 transition-opacity duration-500">
...
export default {
  ...
  data() {
    return {
      ...
      images: [
        {
          src: require("../assets/Group 27.png"),
          hoverSrc: require("../assets/Group 28.png"),
          alt: "Group 5",
          link: '/AboutHolePageDesign'
        },
        {
          src: require("../assets/Group 29.png"),
          hoverSrc: require("../assets/Group 29 (1).png"),
          alt: "Group 6",
          link: '/AboutHolePageDesign'
        }
      ],
