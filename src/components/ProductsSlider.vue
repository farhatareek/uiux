          ...
          >
            <router-link :to="image.link" class="w-full" @click="handleClick">
              ...
              <img
                ...
                :src="image.hoverSrc"
                :alt="`${image.alt} hover`"
                class="w-full  h-auto fancy sm:max-w-lg  md:max-w-5xl object-cover absolute top-0 left-20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              />
...
export default {
  ...
  data() {
    return {
      ...
      images: [
        {
          src: require("../assets/Group 31.png"),
          hoverSrc: require("../assets/Group 32.png"),
          alt: "Group 5",
          link: '/AboutHolePageDesign'
        },
        {
          src: require("../assets/Group 33.png"),
          hoverSrc: require("../assets/Group 34.png"),
          alt: "Group 6",
          link: '/AboutHolePageDesign'
        }
      ],
